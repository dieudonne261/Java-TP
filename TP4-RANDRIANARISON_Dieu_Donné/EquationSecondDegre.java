...
public class EquationSecondDegre extends Frame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == resoudreButton) {
            try {
                ...
                Thread calculThread = new Thread(new CalculRunnable(a, b, c));
                calculThread.start();
    ...
    private class CalculRunnable implements Runnable {
        private double a, b, c;

        public CalculRunnable(double a, double b, double c) {
            this.a = a;
            this.b = b;
            this.c = c;
        }
